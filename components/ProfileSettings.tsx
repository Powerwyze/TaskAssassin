    ...
    <div className="space-y-6 animate-in slide-in-from-right duration-300 pb-24">
      ...
      <div className="bg-slate-800 p-4 rounded-lg border border-slate-700 flex items-center gap-4">
        ...
        <div className="flex-1">
          <div className="text-xs text-slate-500 font-mono mb-1">CODENAME</div>
          <input
            type="text"
            value={userProfile.codename}
            onChange={(e) => onUpdateProfile({ ...userProfile, codename: e.target.value.toUpperCase() })}
            className="w-full bg-slate-900 border border-slate-700 rounded p-2 text-white font-mono font-bold text-lg focus:border-green-500 focus:outline-none uppercase"
          />
